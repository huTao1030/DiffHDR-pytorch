...
def parse_args_and_config():
    ...
    parser.add_argument("--config", type=str, default='hdr.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='./ckpts/Hdr_ddpm3000000.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='hdr',
